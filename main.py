...
def main():
    ...
    audioDetector.set_detection_threshold(10)
    audioDetector.start_detection()

    server =  webserver.WebServer('./web_server', record_path, audioDetector.get_detection_threshold, audioDetector.set_detection_threshold)
